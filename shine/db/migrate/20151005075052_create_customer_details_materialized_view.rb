class CreateCustomerDetailsMaterializedView < ActiveRecord::Migration
  def up
    ...
    execute %{
      CREATE UNIQUE INDEX 
        customers_billing_addresses_customer_id 
      ON
        customers_billing_addresses(customer_id)
    }
    execute %{
      CREATE INDEX 
        customers_shipping_addresses_customer_id 
      ON
  ...
  def down
    ...
    execute "DROP INDEX customers_billing_addresses_customer_id"
    execute "DROP INDEX customers_shipping_addresses_customer_id"
  end
end
